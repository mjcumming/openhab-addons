...
/**
 * The {@link HoneywellTCCHandler} is responsible for handling commands, which are
...
public class HoneywellTCCHandler extends BaseThingHandler {
    ...
    private @Nullable HoneywellTCCConfiguration config;
    ...
    public void initialize() {
        config = getConfigAs(HoneywellTCCConfiguration.class);
