...
![](images/logo-68ceac22.png)

- [HTTP API](#http-api)  - [Abstract](#abstract)
- [Networking](#networking)  - [List of scanned AP's](#list-of-scanned-ap-39-s)
  - [Connect to WiFi](#connect-to-wifi)
  - [Connect to hidden WiFi](#connect-to-hidden-wifi)
  - [Device connection status](#device-connection-status)
  - [Query networking status](#query-networking-status)
  - [Set Manual IP](#set-manual-ip)
  - [Set DHCP](#set-dhcp)
- [Device Information](#device-information)  - [Get Device Metadata](#get-device-metadata)
  - [Get System Log](#get-system-log)
  - [Redirect OTA Server](#redirect-ota-server)
  - [Reboot Device](#reboot-device)
- [Playback Control](#playback-control)  - [Playback Status](#playback-status)
  - [Select Input Source](#select-input-source)
  - [Play a URL](#play-a-url)
  - [Play a M3U File/Playlist](#play-a-m3u-file-playlist)
  - [Play Selected Track](#play-selected-track)
  - [Set Shuffle And Repeat Mode](#set-shuffle-and-repeat-mode)
  - [Control The Playback](#control-the-playback)
  - [Seeking](#seeking)
  - [Adjusting Volume](#adjusting-volume)
  - [Mute and Unmute](#mute-and-unmute)
  - [Play Preset Content](#play-preset-content)
  - [Query Playlist Song Count](#query-playlist-song-count)
  - [Play Notification Sound](#play-notification-sound)
- [USB stick/disk playback](#usb-stick-disk-playback)  - [Get content list from USB stick/disk](#get-content-list-from-usb-stick-disk)
  - [Play from USB stick/disk](#play-from-usb-stick-disk)
  - [Track Info from USB stick/disk](#track-info-from-usb-stick-disk)
- [Multiroom / Multizone](#multiroom-multizone)  - [Add Guest Device to Multiroom Group (Router Mode)](#add-guest-device-to-multiroom-group-router-mode)
  - [Multiroom Overview](#multiroom-overview)
  - [Request a list of Guest Devices in a Multiroom Group](#request-a-list-of-guest-devices-in-a-multiroom-group)
  - [Mute a Guest Device](#mute-a-guest-device)
  - [Remove Guest Device from Multi-Room Group](#remove-guest-device-from-multi-room-group)
  - [Disable Multiroom Mode](#disable-multiroom-mode)
- [Appendix](#appendix)  - [Extended M3U Tags](#extended-m3u-tags)
  - [Hexed Values](#hexed-values)
  - [Changelog](#changelog)
...
[Woodbytes](https://woodbytes.me) and [NWT.Stuff](https://www.facebook.com/NWT.Stuff)
...
| `extch` | _!! DOCUMENTATION IN PROGRESS !!_ |
...
| `GroupName` | _!! DOCUMENTATION IN PROGRESS !!_ |
...
| `SSIDStrategy` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `branch` | Code branch |
...
| `CountryCode` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `CountryRegion` | _!! DOCUMENTATION IN PROGRESS !!_ |
...
| `dst_enable` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `region` | _!! DOCUMENTATION IN PROGRESS !!_ |
...
| `languages` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `streams_all` | _!! DOCUMENTATION IN PROGRESS !!_ |
...
| `external` | hexadecimal value<br>_!! DOCUMENTATION IN PROGRESS !!_ |
...
| `spotify_active` | _!! DOCUMENTATION IN PROGRESS !!_<br>But I guess:<br>Flag that indicates if Spotify is currently playing on the device (via Spotify Connect?)<br>`0`: Spotify is not playing<br>`1`: Spotify is playing |
| `lbc_support` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `privacy_mode` | _!! DOCUMENTATION IN PROGRESS !!_ |
...
| `securemode` | _!! DOCUMENTATION IN PROGRESS !!_ |
...
| `web_firmware_update_hide` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `ignore_talkstart` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `silenceOTATime` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `ignore_silenceOTATime` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `new_tunein_preset_and_alarm` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `iheartradio_new` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `new_iheart_podcast` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `tidal_version` | TIDAL API version |
| `service_version` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `security` | _!! DOCUMENTATION IN PROGRESS !!_ |
| `security_version` | _!! DOCUMENTATION IN PROGRESS !!_ |
...
| `mode` | Playback mode<br>`0`: Idling <br>`1`: airplay streaming<br>`2`: DLNA streaming<br>`10`: Playing network content, e.g. vTuner, Home Media Share, Amazon Music, Deezer, etc.<br>`11`: playing UDISK(Local USB disk on Arylic Device)<br>`20`: playback start by HTTPAPI<br>`31`: Spotify Connect streaming<br>`40`: Line-In input mode<br>`41`: Bluetooth input mode<br>`43`: Optical input mode<br>`47`: Line-In #2 input mode<br>`51`: USBDAC input mode<br>`99`: The Device is a Guest in a Multiroom Zone |
| `loop` | Is a Combination of `SHUFFLE` and `REPEAT` modes<br>`0`: `SHUFFLE:` disabled `REPEAT:` enabled - loop<br>`1`: `SHUFFLE:` disabled `REPEAT:` enabled - loop once<br>`2`: `SHUFFLE:` enabled `REPEAT:` enabled - loop<br>`3`: `SHUFFLE:` enabled `REPEAT:` disabled<br>`4`: `SHUFFLE:` disabled `REPEAT:` disabled<br>`5`: `SHUFFLE:` enabled `REPEAT:` enabled - loop once |
...
| `offset_pts` | _!! DOCUMENTATION IN PROGRESS !!_ |
...
| `alarmflag` | _!! DOCUMENTATION IN PROGRESS !!_ |
...
| Parameter | Description |
| --- | --- |
| `mode` | Activates a combination of Shuffle and Repeat modes<br>`0`: Shuffle disabled, Repeat enabled - loop<br>`1`: Shuffle disabled, Repeat enabled - loop once<br>`2`: Shuffle enabled, Repeat enabled - loop<br>`3`: Shuffle enabled, Repeat disabled<br>`4`: Shuffle disabled, Repeat disabled<br>`5`: Shuffle enabled, Repeat enabled - loop once |
...
| `wmrm_version` | _!! DOCUMENTATION IN PROGRESS Windows Media Rights Management ? !!_ |
...
| `version` | _!! DOCUMENTATION IN PROGRESS !!_ |
