URL: https://www.openhab.org/docs/developer/guidelines.html
---
...
- [A. Directory and File Layout](#a-directory-and-file-layout)
- [B. Code formatting rules & style](#b-code-formatting-rules-style)
...
- [F. Logging](#f-logging)
- [G. Other code attributions](#g-other-code-attributions)
- [Guideline details](#guideline-details)
  - [Static Code Analysis](#static-code-analysis)
  - [Null Annotations](#null-annotations)
...
Rules are enforced as part of the build process using [Spotless Maven Plugin(opens new window)](https://github.com/diffplug/spotless).
...
Code styles files are located in here: [https://github.com/openhab/static-code-analysis/tree/main/codestyle/src/main/resources(opens new window)](https://github.com/openhab/static-code-analysis/tree/main/codestyle/src/main/resources)
...
- Official [openHAB Eclipse IDE setup](/docs/developer/ide/eclipse.html) is preconfigured
- Eclipse standalone installation
  - You can manually import [openhab\_codestyle.xml(opens new window)](https://raw.githubusercontent.com/openhab/static-code-analysis/main/codestyle/src/main/resources/openhab_codestyle.xml) via `Eclipse Preferences -> Java -> Code Style -> Formatter` and [openhab.importorder(opens new window)](https://raw.githubusercontent.com/openhab/static-code-analysis/main/codestyle/src/main/resources/openhab.importorder) via `Eclipse Preferences -> Java -> Code Style -> Organize Imports`
- IntelliJ using plugin [https://plugins.jetbrains.com/plugin/6546-eclipse-code-formatter(opens new window)](https://plugins.jetbrains.com/plugin/6546-eclipse-code-formatter)
...
The rules are defined at [https://github.com/openhab/static-code-analysis/tree/main/codestyle/src/main/resources(opens new window)](https://github.com/openhab/static-code-analysis/tree/main/codestyle/src/main/resources) for the Eclipse WTP formatter, but will have to be manually entered into your IDE.

### [\#](\#java-coding-style) Java Coding Style

- The [Java naming conventions(opens new window)](https://java.about.com/od/javasyntax/a/nameconventions.htm) should always be used and are described in detail at the link, a quick summary is:
...
2. The [OSGi Core Release 8(opens new window)](https://osgi.org/download/r8/osgi.core-8.0.0.pdf) with [OSGi Compendium Release 8(opens new window)](https://osgi.org/download/r8/osgi.cmpn-8.0.0.pdf) is targeted, and newer features should not be used.
3. [SLF4J(opens new window)](http://slf4j.org) is used for logging.
...
- Loggers should be [non-static(opens new window)](http://slf4j.org/faq.html#declared_static), `final` when ever possible and have the name `logger`.
...
The openHAB Maven build includes [tooling for static code analysis(opens new window)](https://github.com/openhab/static-code-analysis) that will validate your code against the Coding Guidelines and some additional best practices.
Information about the checks can be found [here(opens new window)](https://github.com/openhab/static-code-analysis/blob/main/docs/included-checks.md).
...
[Null annotations(opens new window)](https://wiki.eclipse.org/JDT_Core/Null_Analysis) are used from the Eclipse JDT project.
...
- [com.thoughtworks.xstream.io(opens new window)](http://com.thoughtworks.xstream.io)
...
_Caught a mistake or want to contribute to the documentation? [Edit this page on GitHub(opens new window)](https://github.com/openhab/openhab-docs/edit/main/developers/guidelines.md)_

←
[Overview & Introduction](/docs/developer/)[Add-ons](/docs/developer/addons/)
→